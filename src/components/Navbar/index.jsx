            ...
            <div className="container">
                <nav className='navbar'>
                    ...
                    <ul className="list">
                        ...
                        <li className="item"><a className='link' href="#">About</a></li>
                        <li className="item"><a className='link' href="#">News</a></li>
                        <li className="item NavTeach"><a className='link ' href="#">Our Teachers</a></li>
                        <li className="item"><a className='link' href="#">Contact</a></li>
